...
import com.example.loginregistrationlogout.email.EmailSender;
...
public class RegistrationService {
    ...
    public String register(RegistrationRequest request) {
        ...
        stringBuilder.append("http://localhost:8080/api/v1/registration/confirm?token=");
        stringBuilder.append(token);
        emailSender.send(request.getEmail(), buildEmail(request.getFirstName(), stringBuilder.toString()));
